...
public final class SetEquipLockStateRspOuterClass {
  ...
  public interface SetEquipLockStateRspOrBuilder extends
    ...
    /**
     * <code>uint64 target_equip_guid = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TARGET_EQUIP_GUID_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (targetEquipGuid_ != 0L) {
        output.writeUInt64(6, targetEquipGuid_);
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (targetEquipGuid_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(6, targetEquipGuid_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t_equip_guid\030\006 \001(\004\022\017\n\007retcode\030\n \001(\005B\033\n\031e" +
